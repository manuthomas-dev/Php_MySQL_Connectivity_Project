...
Harper Lee's Pulitzer Prize-winning masterwork of honor and injustice in the deep South—and the heroism of one man in the face of blind and violent hatred","book1.jpg","English",0.00);

Insert INTO booksInventory(bookId,invDate,totalInvCount,availInvCount)
VALUES(1,"2010-10-15",100,100);

INSERT INTO books(bookId,bookName,bookAuthor,bookDescription,bookImage,bookLanguage,bookPrice)
VALUES(2,"Nineteen Eighty-Four [1984]","George Orwell","Nineteen Eighty-Four [1984] by George Orwell is a renowned dystopian novel of the life in a future totalitarian state under the watchful eyes of Big Brother.","book2.jpg","English",16.27);

Insert INTO booksInventory(bookId,invDate,totalInvCount,availInvCount)
VALUES(2,"2012-03-17",50,0);

INSERT INTO books(bookid,bookName,bookAuthor,bookDescription,bookImage,bookLanguage,bookPrice)
VALUES(3,"Harry Potter and the Philosopher's Stone","J.K. Rowling","Turning the envelope over, his hand trembling, Harry saw a purple wax seal bearing a coat of arms; a lion, an eagle, a badger and a snake surrounding a large letter 'H'.","book3.jpg","English",19.72);
